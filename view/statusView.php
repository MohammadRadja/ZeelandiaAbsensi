                    ...
                    <tr>
                        ...
                        <td>
                            <strong>
                                <?php if ($jabatan == 'Karyawan'): ?>
                                    <?php
                                    if ($row["Status"] == 'Disetujui' && strpos($row["ApprovedBy"], 'HRD') !== false) {
                                        echo htmlspecialchars($row["Status"]);
                                    } elseif ($row["Status"] == 'Ditolak' && strpos($row["ApprovedBy"], 'HRD') !== false) {
                                        echo htmlspecialchars($row["Status"]);
                                    } elseif ($row["Status"] == 'Disetujui' && (strpos($row["ApprovedBy"], 'SPV') !== false || strpos($row["ApprovedBy"], 'Manager') !== false)) {
                                        echo 'Pending';
                                    } else {
                                        echo htmlspecialchars($row["Status"]);
                                    }
